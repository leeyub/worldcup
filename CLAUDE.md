...
- 배점(300점 만점): 결과60 · 스코어70(승패만30/한팀만15) · 양팀 첫득점자 각40 · 첫골팀15 · 시간대30(인접15) · 전반15 · 카드15 · MVP15 (3경기 합산 900점)
...
- 탭 위계: **현재 경기**(끝나지 않은 첫 경기, `curMatchIdx`)는 크게 강조(`.tab.cur`), **이후 경기**는 흐리게+🔒(`.tab.soon`)→클릭 시 "곧 열려요+D-day" 예고(`comingSoonView`). 종합 탭은 경기별 순위 → 종합 순위 순. 순위 FLIP 애니는 현재 경기 화면(`#lb`)만.
